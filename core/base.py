...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": config("SECRET_KEY"),  # must be consistent
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Python API',
    'DESCRIPTION': 'API documentation for Python API (Django, Django REST Framework, PostgreSQL) managed by PDM',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,  # Split request and response for clarity
